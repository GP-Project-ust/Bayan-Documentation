...
% because Amiri's subsetted ToUnicode CMap is broken under XeTeX, which
% makes copied Arabic text come out as random glyphs. Noto Naskh Arabic
% has a correct ToUnicode CMap that produces clean, searchable,
% copy-pasteable Arabic text — while keeping a professional naskh style.
