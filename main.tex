...
\RenewDocumentCommand{\chapter}{s o m}{%
  ...
  {%  \chapter{...} or \chapter[EN]{AR} — render divider page
    ...
    \begingroup
      ...
      \centering
      % --- Top horizontal rule ---
      {\color{dividersilver}\rule{0.85\textwidth}{0.5pt}\par}

      \vspace{14pt}
      % --- "الفصل" label (small, gray) ---
      {\color{dividersilver}\large الفصل\par}

      \vspace{8pt}
      % --- Big Arabic ordinal (blue-gray, ~60pt, bold) ---
      {\color{dividerdim}\fontsize{60pt}{72pt}\selectfont\bfseries\kauDivOrdinal\par}
