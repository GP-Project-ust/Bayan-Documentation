...
% Engine: LuaLaTeX (required for Arabic + clean PDF text extraction)
%==============================================================================
...
%
% IMPORTANT: We use Noto Naskh Arabic as the main Arabic font (not Amiri)
% because Amiri's subsetted ToUnicode CMap is broken under XeTeX/LuaTeX
% font subsetting, which makes copied Arabic text come out as random
% glyphs (N'Ko, Gurmukhi, etc.) in PDF viewers. Noto Naskh Arabic has a
% correct and complete ToUnicode CMap that survives subsetting.
\setmainfont{Noto Naskh Arabic}[Ligatures=TeX]
\newfontfamily\arabicfont[Script=Arabic]{Noto Naskh Arabic}
\newfontfamily\arabicfontfancy[Script=Arabic]{Amiri}
...
%------------------------------------------------------------------------------
% 5) Languages & bidirectional text
%------------------------------------------------------------------------------
% polyglossia with Arabic automatically loads the correct bidi package:
%   - 'bidi'     for XeTeX  (requires \RequireXeTeX)
%   - 'luabidi'  for LuaTeX
% We must NOT manually \usepackage{bidi} — it would conflict with luabidi
% under LuaLaTeX. Just load polyglossia and let it handle bidi.
\usepackage{polyglossia}
\setmainlanguage[numerals=maghrib]{arabic}
\setotherlanguage{english}

% \setRTL is provided by whichever bidi package polyglossia loaded.
\setRTL
