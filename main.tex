...
%------------------------------------------------------------------------------
% pgfgantt — native Gantt charts for the project schedule (chapter 1).
% Loaded BEFORE bidi (bidi must remain the last package). Defaults below
% bind the charts to the thesis identity colors (kauprimary family).
%------------------------------------------------------------------------------
\usepackage{pgfgantt}
\ganttset{
...
% captions match the caption-package styling (font=small,labelfont=bf) used
...
\long\def\LT@makecaption#1#2#3{%
  \LT@mcol\LT@cols c{\hbox to\z@{\hss\parbox[t]\LTcapwidth{%
    \sbox\@tempboxa{\small\if@RTL\beginR\fi#1{\textbf{#2: }}#3\if@RTL\endR\fi}%
